			...
			do
				...
				do
					...
					do
						...
						sleep 60
						# ycsb load
						/usr/bin/time -v ./bin/ycsb load kvredund -s -P workloads/$testfile -threads $numofthreads -p maxexecutiontime=900 -jvm-args="-Xms16g -Xmx16g" 1>out.log 2> err.log 
						...
						while :
						do
							/usr/bin/time -v ./bin/ycsb run kvredund -s -P workloads/$testfile -threads $numofthreads -p maxexecutiontime=900 -jvm-args="-Xms16g -Xmx16g"  1>out.log 2> err.log  
